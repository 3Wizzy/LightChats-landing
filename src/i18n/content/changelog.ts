    ...
    entries: [
      {
        ...
        changes: [
          "Free, Pro ($9/mo), and Business ($29/mo) plans live",
          ...
          "Auto top-ups: $4.90 (Pro) and $14.90 (Business)",
    ...
    entries: [
      {
        ...
        changes: [
          "Plans Gratuit, Pro (9 $/mois) et Business (29 $/mois) disponibles",
          ...
          "Recharges automatiques : 4,90 $ (Pro) et 14,90 $ (Business)",
    ...
    entries: [
      {
        ...
        changes: [
          "إتاحة باقات Free وPro (9$/شهر) وBusiness (29$/شهر)",
          ...
          "إعادة شحن تلقائية: 4.90$ (Pro) و14.90$ (Business)",
