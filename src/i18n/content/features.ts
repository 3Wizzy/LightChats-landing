    ...
    features: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Cap reached? Replies pause until the 1st — no surprise charges",
          "$4.90 / +250 AI / +2,500 static (Pro) or $14.90 / +2,000 AI / +10,000 static (Business)",
        ],
      },
    ],
    ctaTitle: "See it run on your account",
    ctaSub:
      "Sign up and build for free — pay only when you activate. Connect Instagram in two minutes.",
    ...
    features: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Plafond atteint ? Les réponses s'interrompent jusqu'au 1er — aucun prélèvement surprise",
          "4,90 $ / +250 IA / +2 500 statiques (Pro) ou 14,90 $ / +2 000 IA / +10 000 statiques (Business)",
        ],
      },
    ],
    ctaTitle: "Voyez-le fonctionner sur votre compte",
    ctaSub:
      "Inscrivez-vous et construisez gratuitement — payez seulement à l'activation. Connectez Instagram en deux minutes.",
    ...
    features: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "وصلت إلى الحد؟ تتوقف الردود حتى الأول من الشهر — بدون رسوم مفاجئة",
          "4.90$ / +250 ذكاء اصطناعي / +2,500 ثابت (Pro) أو 14.90$ / +2,000 ذكاء اصطناعي / +10,000 ثابت (Business)",
        ],
      },
    ],
    ctaTitle: "شاهده يعمل على حسابك",
    ctaSub:
      "سجّل وأنشئ مجاناً — وادفع فقط عند التفعيل. اربط إنستغرام في دقيقتين.",
    ctaBtn: "ابدأ مجاناً",
