/**
 * Compact trust chip (row under hero CTAs). "meta" renders the Meta infinity
 * mark in Meta blue (path: Simple Icons "Meta", CC0); "check" renders a
 * neutral checkmark.
 */
  ...
  return (
    <div className="inline-flex items-center gap-2 bg-white/5 border border-white/10 rounded-full px-3.5 py-1.5">
      {icon === "meta" ? (
        ...
        <svg
          className="w-4 h-4 flex-shrink-0 text-surface-400"
          fill="none"
          stroke="currentColor"
          strokeWidth={2}
          viewBox="0 0 24 24"
